...
func TestSetMapValue(t *testing.T) {
	...
	SetMapValue(nestedMap, "firstKey", 100, 42)
	...
	SetMapValue(nestedMap, "secondKey", 200, 99)
	...
	SetMapValue(nestedMap, "firstKey", 101, 43)
...
func TestSetMapValue3(t *testing.T) {
	...
	SetMapValue3(nestedMap3, "firstKey", 100, 1.23, "Value A")
	...
	// Test: Set another value in the map
	SetMapValue3(nestedMap3, "secondKey", 200, 4.56, "Value B")
	...
	// Test: Set a value in an existing outer map key
	SetMapValue3(nestedMap3, "firstKey", 101, 7.89, "Value C")
